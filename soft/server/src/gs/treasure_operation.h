...
public:
	enum
	{
		TREASURE_SLOT_SIZE = 100,
		TREASURE_EXPAND_BASE = 5,
		TREASURE_EXPAND_SIZE = 10,
	};

	static void treasure_refresh_luck(dhc::player_t *player);

	static void treasure_refresh(dhc::player_t *player, bool login);

	static void treasure_clear(dhc::player_t *player);

	static void treasure_refresh_rate(dhc::treasure_t *treasure,
	...
	static bool get_star_return(dhc::player_t *player, dhc::treasure_t *treasure, s_t_rewards& rds);
};
