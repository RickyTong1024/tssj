...
@interface SBasePluginPlatform : SPluginPlatform
{
    BOOL didCallInitSDKMethod;
    BOOL didCallLoginMethod;
    BOOL initSucceed;
    BOOL loginVerifyTokenTimeout;
}

@property (readonly, getter = getAppInfo) SAppInfo *appInfo;
...
@property (readonly, copy) NSString *payCallbackURL;
