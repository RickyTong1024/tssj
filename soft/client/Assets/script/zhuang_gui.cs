...
public class zhuang_gui : MonoBehaviour {
	...
	public void reset(int num)
	{
		...
		int num1 = m_num_list.Count;
		if(m_num_list.Count < 5)
		{
			for(int i = 0 ; i < 5 - num1; ++i)
			{
				m_num_list.Add(0);
			}
		}
		...
		for (int i = 0; i < m_nums.Length; ++i)
		{
			if (i < m_num_list.Count)
			{
				...
				m_nums[i].transform.localPosition = new Vector3(200 - i * 100 , 0, 0);
			}
			else
			{
