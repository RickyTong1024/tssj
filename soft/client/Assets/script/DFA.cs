...
public class DFA 
{
	public static DFA _instance = null;
	...
	public int init()
	{
		if (game_data._instance.m_dbc_prohibitword == null)
		{
			return -1;
		}
		
		for (int i = 0; i < game_data._instance.m_dbc_prohibitword.get_y(); ++i)
		{
			this.add_keyword(game_data._instance.m_dbc_prohibitword.get(i,0));
		}
		this.rebuild_dfa();
