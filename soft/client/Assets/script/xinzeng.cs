...
public class xinzeng : MonoBehaviour {
	...
	public void click(GameObject obj)
	{
		if (obj.name == "add")
		{
			protocol.game.cmsg_social_agree _msg = new protocol.game.cmsg_social_agree ();
			_msg.player_guid = m_social_player.player_guid;
			_msg.agree = 1;
			net_http._instance.send_msg<protocol.game.cmsg_social_agree> (opclient_t.CMSG_SOCIAL_AGREE, _msg);
		}
		if (obj.name == "hulve")
		{
			protocol.game.cmsg_social_agree _msg = new protocol.game.cmsg_social_agree ();
