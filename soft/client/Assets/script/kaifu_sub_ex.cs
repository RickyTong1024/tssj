...
public class kaifu_sub_ex : MonoBehaviour {
	...
	public void reset()
	{
		...
		m_num.GetComponent<UILabel>().text = string.Format(game_data._instance.get_t_language ("kaifu_sub_ex.cs_67_54"), (m_toltal_count - m_count) , m_toltal_count);//剩余次数 {0}/{1}
	...
	public void click(GameObject obj)
	{
		if (obj.name == "get")
		{
			if(flag == 1)
			{
				...
				root_gui._instance.show_select_item_gui(m_id,rewards,"select_kaifu_ex",2,total_num);
			}
			else
			{
				s_message _message = new s_message();
				_message.m_type = "select_kaifu_ex";
