...
public class arena_saodang : MonoBehaviour {

	public GameObject m_view;
    List<protocol.game.smsg_sport_fight_end> m_rewards;
    ...
    public void init(List<protocol.game.smsg_sport_fight_end> rewards)//List<int> golds,List<int> powders,List<int> suipians
    {
        m_rewards = rewards;
    ...
    void deal()
    {
        GameObject obj = game_data._instance.ins_object_res("ui/arena_saodang_sub");
        obj.transform.parent = m_view.transform;
        obj.transform.localScale = Vector3.one;
        obj.transform.localPosition = new Vector3(0, 93 - m_index * 158, 0);
        obj.GetComponent<arena_saodang_sub>().reward = m_rewards[m_index];
        obj.GetComponent<arena_saodang_sub>().m_num = m_index + 1;
        obj.GetComponent<arena_saodang_sub>().init();
