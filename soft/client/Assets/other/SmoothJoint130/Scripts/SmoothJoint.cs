...
public class SmoothJoint : MonoBehaviour,IMessage {

	[Header("- Initial setup ------------------------")]
	public bool ChildAutoSetOn = false;//Child hierarchy automatic registration
    public bool m_add_bones = false;
    ...
    [Header("dynamic_joint头部碰撞体")]
    public bool m_heards_collide = false;
    
    [Header("dynamic_joint大胳膊碰撞体")]
    public bool m_upper_collide  = false;

    [Header("dynamic_joint小胳膊碰撞体")]
    public bool m_lower_collide  = false;
    
    [Header("dynamic_joint身体碰撞体")]
    public bool m_body_collide  = false;
    
    [Header("dynamic_joint臀部碰撞体")]
    public bool m_hip_collide  = false;
    
    [Header("dynamic_joint大腿碰撞体")]
    public bool m_thigh_collide  = false;
    
    [Header("dynamic_joint小腿碰撞体")]
    public bool m_calf_collide  = false;
	...
	public void Start()
	{
        ...
        this.transform.name = "smooth_joint_root";
        ...
        _msg.time = 0.1f;
        _msg.m_type = "sjoint_start";
        _msg.m_object.Add(this);
    ...
    {
        if (message.m_type == "off_sjoint")
        {
            this.enabled = false;
        }

        if (message.m_type == "on_sjoint")
        {
            this.enabled = true;
        }

        if (message.m_type == "sjoint_start" && message.m_object[0] == this)
        {
            m_start = true;
            Init();
        }
