...
////// Emissive:
                ...
                float node_4099_ang = (3.141592654*_Alpha01_UVangle);
                float node_4099_spd = 1.0;
                float node_4099_cos = cos(node_4099_spd*node_4099_ang);
                float node_4099_sin = sin(node_4099_spd*node_4099_ang);
                float2 node_4099_piv = float2(0.5,0.5);
                float2 node_4099 = (mul(i.uv0-node_4099_piv,float2x2( node_4099_cos, -node_4099_sin, node_4099_sin, node_4099_cos))+node_4099_piv);
                float4 _Alpha01_var = tex2D(_Alpha01,TRANSFORM_TEX(node_4099, _Alpha01));
