...
////// Emissive:
                ...
                float node_5317_ang = (3.141592654*_MaskE01_UVangle);
                float node_5317_spd = 1.0;
                float node_5317_cos = cos(node_5317_spd*node_5317_ang);
                float node_5317_sin = sin(node_5317_spd*node_5317_ang);
                float2 node_5317_piv = float2(0.5,0.5);
                float2 node_5317 = (mul(i.uv0-node_5317_piv,float2x2( node_5317_cos, -node_5317_sin, node_5317_sin, node_5317_cos))+node_5317_piv);
                float4 _MaskE01_var = tex2D(_MaskE01,TRANSFORM_TEX(node_5317, _MaskE01));
