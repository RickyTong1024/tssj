...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
			...
			NGUIEditorTools.DrawPaddedProperty("Language", serializedObject, "mLanguage");
			NGUIEditorTools.DrawPaddedProperty("Id", serializedObject, "mId");
            NGUIEditorTools.DrawPaddedProperty("Confusion", serializedObject, "mConfusion");
