...
public class UISprite : UIBasicSprite
{
	...
	public void set_enable(bool flag)
	{
		...
		if (!flag)
		{
			...
			if (ori_name == "an_tongyong01a" || ori_name == "an_tongyong01b" || ori_name == "an_tongyong01c" || ori_name == "an_tongyong01d")
			{
				spriteName = "an_tongyong01e";
			}
			else if (ori_name == "scbutton")
			{
				spriteName = "scbutton_ft";
			}
			else if (ori_name == "szjm_jsxan" || ori_name == "szjm_yzbxan" || ori_name == "szjm_zbxan" || ori_name == "szjm_zsxan")
			{
				spriteName = "szjm_tyxan_ft";
			}
			else if (ori_name == "xsdan_aan001")
			{
				spriteName = "xsdan_aan003f";
			}
			else if (ori_name == "zr_butter01")
			{
				spriteName = "zr_butter02";
			}
			else if(ori_name =="xxgzd_cjjm001")
			{
				spriteName = "xxgzd_cjjm002";
			}
			else if(ori_name == "jtlt_xdk001")
			{
				spriteName = "nnssl_hbxq_bg";
				this.GetComponent<BoxCollider>().enabled =true;
			}
			else if(ori_name == "cshd_xzk003a" )
			{
				spriteName = "cshd_xzk003";
			}
			if (this.transform.childCount == 1)
			{
				UILabel ul = this.transform.GetChild(0).GetComponent<UILabel>();
				if (ul != null)
				{
					if (!gc)
					{
						g1 = ul.gradientBottom;
						g2 = ul.gradientTop;
						g3 = ul.effectColor;
						gc = true;
					}
					ul.gradientBottom = new Color32(94, 94 ,94, 255);	
					ul.gradientTop = new Color32(15, 15 ,15, 255);	
					ul.effectColor = new Color32(114, 114, 114, 255);
					if (ori_name == "xsdan_aan001")
					{
						ul.gradientBottom = new Color32(43, 43 ,43, 255);	
						ul.gradientTop = new Color32(131, 131 ,131, 255);	
					}
				}
			}
		}
